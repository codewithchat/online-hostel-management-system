<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="byroomno.aspx.cs" Inherits="Hostel_management.proj.byroomno" %>
            ...
            <tr style="background-color: #8EEBEC">
             ...
             <tr>
                <td style="text-transform: uppercase"class="auto-style3">
                    <asp:Label ID="Label1" runat="server" Text="Enter Room_NO" BackColor="Silver"></asp:Label>
               </td>
